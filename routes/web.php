...
Route::middleware(['IsLogin', 'IsPS'])->group(function () {
    Route::prefix('/ps')->name('ps.')->group(function() {
        Route::prefix('/student')->name('student.')->group(function () {
            Route::get('/index', [PSController::class, 'index'])->name('index');
        });
        Route::prefix('/late')->name('late.')->group(function () {
            Route::get('/index', [PSController::class, 'index2'])->name('index');
            Route::get('/show', [PSController::class, 'show'])->name('show');
        });
     });
